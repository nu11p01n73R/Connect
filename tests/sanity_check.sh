...
(sanity_checks && echo "SANITY CHECKS PASSED") || (echo "SANITY CHECKS FAILED" && CONFIG_FILE=$CONFIG_FILE_BACKUP)
...
(sanity_checks && echo "SANITY CHECKS PASSED") || (echo "SANITY CHECKS FAILED" && KEY_FILE_PREFIXES=$KEY_FILE_PREFIXES_BACKUP)
